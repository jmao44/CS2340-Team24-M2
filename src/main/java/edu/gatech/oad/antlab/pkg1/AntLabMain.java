 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Junyan Mao");
		  toPrint += p1.toString("jmao44");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Chengkai Yang");
		  toPrint += p2.toString("cyang389");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Tiantong Li");
		  toPrint += p3.toString("tli385");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("XiaoyingYang");
                  toPrint += p4.toString("xyang383");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Xueming Yin");
                  toPrint += p5.toString("xyin49");
